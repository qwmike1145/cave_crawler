...
public class HandleCaveSound {
    public static void handle(final CaveSound packet) {
        ...
        if (soundEvents == null) {
            CaveCrawler.LOG.error("Forge Sound registry was null while handling packet");
            return;
        }
        ...
        if (soundEvent == null) {
            CaveCrawler.LOG.error("Sound Event [" + packet.soundResource + "] was null while handling packet");
            return;
        }
